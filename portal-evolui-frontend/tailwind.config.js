...
const themes = {
  ...
  'default': {
    ...
    accent   : { ...colors.slate, DEFAULT: colors.slate[800] },
    warn     : { ...colors.red, DEFAULT: colors.red[600] },
    'on-warn': { 500: colors.red['50'] }
  },
  'blue'   : { primary: { ...colors.blue, DEFAULT: colors.blue[600] } },
  'teal'   : { primary: { ...colors.teal, DEFAULT: colors.teal[600] } },
  'green'  : { primary: { ...colors.green, DEFAULT: colors.green[600] } },
  'purple' : { primary: { ...colors.purple, DEFAULT: colors.purple[600] } },
  'red'    : { primary: { ...colors.red, DEFAULT: colors.red[600] } },
  'orange' : { primary: { ...colors.orange, DEFAULT: colors.orange[600] } },
  'amber'  : { primary: { ...colors.amber, DEFAULT: colors.amber[600] } },
  'pink'   : { primary: { ...colors.pink, DEFAULT: colors.pink[600] } },
  'wine'   : { primary: { ...wine, DEFAULT: wine[600] } }
};
...
const config = {
  ...
  safelist     : [
    ...
    { pattern: /^theme/ },
    { pattern: /^mat/ },
    { pattern: /^text-(red|green|orange|yellow|blue|purple|teal|gray|amber|pink|indigo|wine)-(50|100|200|300|400|500|600|700|800|900)/ },
    { pattern: /^bg-(red|green|orange|yellow|blue|purple|teal|gray|amber|pink|indigo|wine)-(50|100|200|300|400|500|600|700|800|900)/ }
  ],
  theme       : {
    colors  : {
